...
void initialize() {
  ...
  read_input() ;
    ...
    if(new_chiAB > 0 ) chiAB = new_chiAB;
  ...
  cout<<"kappa "<<kappa<<" chiAB "<<chiAB<<endl;
...
void allocate( ) {
  ...
  for(i=0;i<Dim;i++){
	...
	vir_func_hat[i] = (complex<double>**) calloc(Dim, sizeof(complex<double>*));
